...
import { GetFeedGateway, GetPaginatedFeedByTypeGateway, FeedResponse } from "../business/gateways/FeedGateway";
...
export class FeedDataBase implements GetFeedGateway, GetPaginatedFeedByTypeGateway{
